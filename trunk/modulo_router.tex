...
longitudDeEventosValida(e.status$\_$inter, e.cantInterfaces) \yluego \\ %aca ya se que se puede hacer de una pero queda mas declarativo asi
interfazDeEventosCorrecta(e.cantInterfaces, e.status$\_$inter) \yluego \\
tiempoCaidaValido(e.status$\_$inter)\\
