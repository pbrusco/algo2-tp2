...
\hspace*{3.2cm} $\wedge$ interfacesDeArbolesValidas(e.reglas, e.cantInterfaces)\\
...
\func{estaVersionEnTupla}{dirIp,secuOrdSinRep(tupla(version,abr))}{bool}{}
...
\func{interValidasAux}{secuOrdSinRep(tupla(version,abr))/s,nat,dirIp/d}{bool}{estaVersionEnTupla(d,s)}
